  ...
  return (
    <div className='coaching-info-div-container'>
      ...
      <div className='coaching-info-container'>
        <div className='coaching-info-content container' data-aos="zoom-in-up">
        ...
        <ul className='info-top'>
          <li>
            ...
            <h3>Gut and Digestive Wellness</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
          </li>
          <li>
            <span className='svg-icon-public-container'>
            ...
            <h3>Blood Chemistry Interpretation</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
          </li>
          <li>
          <span className='svg-icon-public-container'>
            ...
            <h3>Custimized Supplement Protocols</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
          </li>
          </ul>
        </div>
