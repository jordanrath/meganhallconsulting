    ...
    <div className='coaching-info-div-container'>
      <div className='svg-coaching-info-container-top'>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 90 1440 100" preserveAspectRatio='none'>
                <path fill="#b56357" fillOpacity="1" d="M -2 144 L -3 143 C 26 124 135 129 222 156 C 474 207 651 182 731 164 C 804 149 1081 47 1444 120 L 1445 120 L 1450 321 L 1360 320 C 1280 320 1120 320 960 320 C 800 320 640 320 480 320 C 320 320 160 320 80 320 L 0 320 Z"></path>
            </svg>
        </div>
